...
aboutTab.onclick = function() {
  ...
  projectsSection.setAttribute("class", "hidden")
  aboutTab.setAttribute("class", "current-item")
  aboutSection.classList.remove("hidden");
  homeTab.classList.remove("current-item");
  projectsTab.classList.remove("current-item");
  homeTab.setAttribute("class", "bar-item");
  projectsTab.setAttribute("class", "bar-item");
}
...
projectsTab.onclick = function() {
  aboutSection.setAttribute("class", "hidden");
  homeImage.setAttribute("class", "hidden")
  projectsTab.setAttribute("class", "current-item")
